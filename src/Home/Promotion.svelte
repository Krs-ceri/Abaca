...
<section class="section promotion">
	<div class="demo">
		<Carousel on:change={changed} {...carousels}>
			...
			<div class="slide-content">
				<section>
					<img alt="Promotion 1" src="assets/promotion.png"  >
				</section>
			</div>
			<div class="slide-content">
				<section>
					<img alt="Promo 2" src="assets/promotion2.png" >
				</section>
			</div>
	...
	<center> <a class="waves-effect waves-light btn-small">Promotion !</a> </center>
</section>
